...
namespace ProgramacionGrafica
{
    public class Punto
    {
        ...
        public Punto Scale(float sx, float sy, float sz)
        {
            ...
            Vector4 scaledVector = Vector4.Transform(new Vector4(x, y, z, 1), scalingMatrix);
        ...
        public Punto Translate(float dx, float dy, float dz)
        {
            ...
            Vector4 translatedVector = Vector4.Transform(new Vector4(x, y, z, 1), translationMatrix);
